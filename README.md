...
Repository Contents
FileDescription06_SQL_Master_StepByStep.sqlForensic workbench — standalone queries executed sequentially for step-by-step audit07_SQL_Production_CTE.sqlProduction architecture — single coherent CTE chain covering all analytical dimensions08_Python_Audit_Notebook.ipynbPython replication — all SQL findings confirmed in pandas, structured as a Kaggle-ready notebook
